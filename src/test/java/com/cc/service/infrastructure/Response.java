...
public class Response {
	...
	public Response(Map<String, Iterable<String>> reponseHeaders, byte[] responseData, Exception failure, int statusCode){
		super();
	 ...
	 * 			404 or 500. If no such failure occurred this method returns null.
	 */
	...
	public void toFile(String fileName){
		try{
			...
			FileUtils.writeByteArrayToFile(new File(fileName), this.responseData);
		} catch(IOException e){
